...
class QLearningSolver(BaseSolver):
    ...
    def step(self):
        ...
        for t in range(self._max_steps_per_episode+1):
            ...
            self._Q[state, action] += self._alpha * td_delta # Q update
    ...
    # takes (s, a) and returns a list of action probs dictated by Q
    def _policy_function(self, observation):
        ...
        best_action = np.argmax(self._Q[observation]) # Q(s, a) = a'?
