...
class BenchmarkExperiment(experiments.BaseExperiment):
    ...
    def perform(self):
        ...
        pipe = Pipeline([('NN', mlp)], memory=experiments.pipeline_memory) # perform grid search over NN
        ...
        gs, _ = self.gs_with_best_estimator(pipe, experiments.BEST_NN_PARAMS, type='ass1') # run the NN with best params from assignment 1
