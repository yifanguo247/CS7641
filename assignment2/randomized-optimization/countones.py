...
# Adapted from https://github.com/JonathanTay/CS-7641-assignment-2/blob/master/countones.py
...
OUTPUT_DIRECTORY = './output_backup'
N = 100
maxIters = 5001
numTrials = 5
fill = [2] * N
...
outfile = OUTPUT_DIRECTORY + '/COUNTONES/COUNTONES_{}_{}_LOG.csv'
